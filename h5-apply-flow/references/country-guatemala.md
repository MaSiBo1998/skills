...
- vendor 架构：仅当目标项目已采用 vendor 架构、用户明确要求，或 checkpoint 已有 `vendor_enabled=true` 时，保留 `static-app/vendor/` 与 `scripts/build-static.mjs`；依赖包括 React、ReactDOM、React Router、Redux Toolkit、React Redux、antd-mobile。
