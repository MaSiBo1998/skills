...
5. 读取个人知识库的 H5 场景知识：通用进件读 `Work/H5/业务场景/进件流程.md`；涉及表单输入、键盘或移动端交互时读 `Work/H5/公共规范/移动端表单与交互约束.md`；涉及 App WebView 时读 `Work/H5/公共规范/App WebView兼容.md`；涉及视觉还原、截图预算、拍照图片质量时读 `Work/H5/公共规范/视觉还原与截图预算.md`。不要按 appName 自动追加 app 专属页。
