...
description: 测试验收。用于执行 14 项通用检查、vendor 架构检查、Apply 专项检查、首复贷状态流专项检查、进件国家差异专项检查、官网/协议/挂载 H5 专项检查、管理后台专项检查，并输出通过/失败结果。
---
...
- 管理后台项目必须额外检查路由/菜单入口、权限展示、列表或详情页数据流、Element UI 交互、后台接口错误态、i18n 文案和构建结果。
