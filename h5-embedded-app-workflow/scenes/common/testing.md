...
**场景 C + 危地马拉**: 需额外执行 `references/guatemala-apply.md` 的验收补充：产品/国家确认、header/endpoint/request/response 映射完整、旧混淆字段无残留、接口结构未重构、原生回调协议未改、entry 四种模式正确、Confiq-H5 步骤顺序正确
