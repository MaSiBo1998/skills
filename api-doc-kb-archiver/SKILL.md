...
description: 接口文档入库到个人知识库。用于用户要求“接口文档入库、记录接口到知识库、整理项目接口、从项目提取接口、归档 app 接口、生成接口 contract、生成 API 索引、把 swaggerApi.json/api.md 沉淀到 KB”时；按 appName 写入 personal-ai-kb/API/apps/<appName>，生成全局配置、原生交互、中文接口 contract 和快速检索索引。
---
...
4. 生成或更新 app 文档：
   ...
   - `原生交互.md`：原生方法、callback、字段、混淆名、方向和用途。
