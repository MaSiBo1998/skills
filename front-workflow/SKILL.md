...
工作类请求默认先进入本 skill。这里的工作类请求包括代码修改、项目开发、skill 调整、workflow 优化、H5/后台/Flutter、发布、发版检查、发布前检查、设计图、接口、字段、样式、文案和“帮我修一下/改一下/小需求”等普通改动。纯闲聊、翻译、查时间等明显非工作请求可以跳过本 skill。
