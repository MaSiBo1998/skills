...
STAGE_LABELS = {
    "direction_selection": "选择小说方向",
    "route_selection": "选择三套故事路线之一",
    "outline_design": "生成并确认整书与分卷大纲",
    "protagonist_design": "完善主角",
    "family_design": "完善家庭背景",
    "key_characters_design": "完善第一卷核心人物",
    "relationships_design": "完善双向人物关系",
    "world_design": "确认时代、地点与事实边界",
    "outline_review": "人物与大纲双向校准",
    "packaging": "生成并确认书名简介",
    "opening_design": "生成并确认前三章",
    "ready_to_write": "等待用户明确确认开始正文",
    "writing": "正文连载",
}
...
def render_skill_entry(state: dict) -> str:
    ...
    if needs_design_context(state):
        ...
        if not is_guided_state(state):
            lines.extend(
                [
                    "",
                    "## 旧项目门禁",
                    "",
                    "- 当前项目缺少 schema v2 设计确认记录。",
